...
[src/utils/config.ts:42](https://github.com/sticky/sticky-utils-lotion/blob/0fd9242/src/utils/config.ts#L42)
...
[src/utils/config.ts:10](https://github.com/sticky/sticky-utils-lotion/blob/0fd9242/src/utils/config.ts#L10)
