...
[src/utils/config.ts:42](https://github.com/sticky/sticky-utils-lotion/blob/7bb5b11/src/utils/config.ts#L42)
...
[src/utils/config.ts:10](https://github.com/sticky/sticky-utils-lotion/blob/7bb5b11/src/utils/config.ts#L10)
